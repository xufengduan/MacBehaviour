...
# MacBehaviour: 在大语言模型上进行心理学实验

</div>

`MacBehaviour` R 包为复制大型语言模型（LLMs）的经典实验提供了一个用户友好的工具包。该包含一系列专为LLMs实验设计的功能，涵盖了OpenAI 的 GPT 系列、Huggingface 的 Llama 系列以及开源模型。

有关详细信息和引用，请参阅预印本: <a href="https://arxiv.org/abs/2405.07495"> Duan, X., Li, S., & Cai, Z. G. (2024). MacBehaviour: An R package for behavioural experimentation on large language models. </a>
<br><br>CRAN 上的版本可能已经过时，但您可以在<a href="https://doi.org/10.31234/osf.io/ywtfd">这里</a>找到相应的教程。
